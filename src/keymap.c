...
const uint16_t PROGMEM combo_sym_scln[]  = {T_L_IN,        KC_I,          COMBO_END};
const uint16_t PROGMEM combo_sym_sft[]   = {T_L_IN,        KC_H,          COMBO_END};
...
const HSV PROGMEM ledmap[][RGB_MATRIX_LED_COUNT] = {
  ...
  [ALPHA] = {
    ...
    C_PRP, C_PRP, C_SLV, C_PRP, C_GRN, C_OFF,       // P H A I O(outer)
