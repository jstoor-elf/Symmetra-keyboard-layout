...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYS] = LAYOUT_voyager(
    KC_NO,          KC_NO,               KC_NO,               KC_NO,               KC_NO,               KC_NO,                     KC_NO,          KC_NO,          KC_NO,          KC_NO,             KC_NO,             KC_NO,
    KC_NO,          KC_AUDIO_VOL_DOWN,   KC_AUDIO_VOL_UP,     KC_NO,               KC_AUDIO_MUTE,       KC_NO,                     KC_NO,          U_PREV_TAB,     U_NEXT_TAB,     U_PREV_APP_WINDOW, U_NEXT_APP_WINDOW, U_LOCK_SCREEN,          
    KC_NO,          RGB_VAD,             RGB_VAI,             KC_NO,               RGB_TOG,             KC_NO,                     KC_NO,          U_SHOW_DESKTOP, U_SHOW_APPS,    U_PREV_APP,        U_NEXT_APP,        KC_NO,          
